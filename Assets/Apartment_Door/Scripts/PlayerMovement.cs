...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        yRot = Input.GetAxis(Axis.MouseX) * horizontalSensitivity;
        xRot += Input.GetAxis(Axis.MouseY) * verticalSensitivity;
        ...
        moving = Input.GetAxis(Axis.Vertical) * -playerMovingSpeed;
        strafe = Input.GetAxis(Axis.Horizontal) * -strafeSpeed;
